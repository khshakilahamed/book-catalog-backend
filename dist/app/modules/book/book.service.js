...
const getAllFromDB = (filters, options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const minPriceFromDB = yield prisma_1.default.book.findFirst({
        select: {
            price: true,
        },
        orderBy: {
    ...
    const maxPriceFromDB = yield prisma_1.default.book.findFirst({
        select: {
            price: true,
        },
        orderBy: {
    ...
    const floatMinPrice = minPrice ? parseFloat(minPrice) : minPriceFromDB === null || minPriceFromDB === void 0 ? void 0 : minPriceFromDB.price;
    const floatMaxPrice = maxPrice ? parseFloat(maxPrice) : maxPriceFromDB === null || maxPriceFromDB === void 0 ? void 0 : maxPriceFromDB.price;
